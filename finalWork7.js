...
function starRotation(){
    ...
    rotation_self(moon);
    rotation_self(lava);
    rotation_self(Mercury);
    rotation_self(Uranus);
    rotation_public(earth,0.005,'horizontal');
    rotation_public(moon,0.008,'horizontal');
    rotation_public(lava,0.016,'horizontal');
    rotation_public(Mercury,0.002,'horizontal');
    rotation_public(Uranus,0.006,'vertical')
}
